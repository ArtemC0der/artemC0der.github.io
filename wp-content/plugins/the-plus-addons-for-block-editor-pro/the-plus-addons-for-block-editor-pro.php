...
* Text Domain: tpgbp
*/
update_option( 'tpgbp_license_status', [
'status' => 'valid',
'expired' => '2040-05-13 23:59:59',
'message' => 'Your License successfully activated.'
]);
update_option( 'tpgb_activate', [
'tpgb_activate_key' => 'fc6ce8ac088c32711707f1a962dbcdf0'
]);
if ( ! defined( 'ABSPATH' ) ) {
	exit;
}

defined( 'TPGBP_VERSION' ) or define( 'TPGBP_VERSION', '2.0.6' );
