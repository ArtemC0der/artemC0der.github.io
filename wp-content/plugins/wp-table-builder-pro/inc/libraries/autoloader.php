 ...
 *
 * The argument should be in the form: WP_Table_Builder_Pro\Namespace. The
...
spl_autoload_register( function( $class_name ) {
	...
	if ( false === strpos( $class_name, 'WP_Table_Builder_Pro' ) ) {
		return;
	}
    ...
    if( $file_parts[0] !== 'WP_Table_Builder_Pro' ) {
        return;
    }
