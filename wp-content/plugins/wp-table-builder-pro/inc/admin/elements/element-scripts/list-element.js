    ...
    tinyMCE.init({
        ...
        init_instance_callback: function (editor) {
            ...
            editor.on('click', function (e) {
                ...
                var nodes = Array.prototype.slice.call(ulElem.children);
...
function proControlsChange(inputs, element) {
    if (inputs && typeof inputs === 'object') {
        ...
        } else if (inputs.hasOwnProperty('listAlignment')) {
            window.setTimeout(() => {
...
WPTB_Helper.controlsInclude(element, proControlsChange);
